      ...
      <div className="mt-4 space-y-3">
        {hasActivities ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-8 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Adicione atividades para este dia</p>
            <Button variant="ghost" size="sm" className="mt-3" onClick={() => onAddActivity(date)}>
              <Plus className="mr-1.5 h-4 w-4" />
              Adicionar atividade
            </Button>
          </div>
